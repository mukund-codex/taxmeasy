                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <br>
                                    <input type="text" class="form-control" name="total_expenses" placeholder="Total Expenses"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <br>
                                    <input type="text" class="form-control" name="mediclaim_amount" placeholder="Total mediclaim policy amount"
                                        value="<?php if(!empty($data['mediclaim_amount'])) { echo $data['mediclaim_amount']; } ?>">
                                    <br>
                                    <input type="text" class="form-control" name="housing_interest" placeholder="Housing Loan Interest %"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <br>
                                    <input type="text" class="form-control" name="alternate_number" placeholder="Alternate No."
                                        value="<?php if(!empty($data['alternate_number'])) { echo $data['alternate_number']; } ?>">
                                    <br>
                                    <input type="text" class="form-control" name="yearly_income" placeholder="Total Yearly Income"
                                        value="<?php if(!empty($data['yearly_income'])) { echo $data['yearly_income']; } ?>">
                                    <br>
                                    <input type="text" class="form-control" name="insurance_amount" placeholder="Total Insurance Amount"
                                        value="<?php if(!empty($data['insurance_amount'])) { echo $data['insurance_amount']; } ?>">
                                    <br>
                                    <input type="text" class="form-control" name="housing_repayment" placeholder="Housing Loan Repayment"
                                    ...
                                    <input type="hidden" name="client_id" id="client_id" value="<?php if(!empty($data['id'])) { echo $data['id']; } ?>"
                                    <div class="clearfix"><button class="btn btn-info form-control" name="submit"
