<?php
	...
	$sql = "SELECT cr.*, cl.name, cl.email, cl.mobile, cl.username FROM ".PREFIX.$tableName." cr JOIN clients cl ON cl.id = cr.client_id WHERE cr.deleted_at IS NULL order by cr.created_at DESC";
...
<head>
    ...
    <title>Taxmeasy | Client List</title>
