<?php
	...
	if(isset($_POST['register'])){
		if($csrf->check_valid('post')) {			
			$result = $admin->addClient($_POST);
			header("location: client-list.php?registersuccess");
			exit;
		}
	}
	...
	if(isset($_GET['edit'])){
		...
		$data = $admin->getUniqueClientById($id);
	}

	if(isset($_POST['update'])) {
		if($csrf->check_valid('post')) {
			$id = trim($admin->escape_string($admin->strip_all($_POST['id'])));
			$result = $admin->updateClient($_POST);
			header("location: client-list.php?updatesuccess&edit&id=".$id);
			exit;
		}
	}
?>
                                            ...
                                            <form method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 field">
                                                        ...
                                                        <input type="text" name="state" id="state" placeholder="State" value="<?php if(isset($_GET['edit'])){ echo $data['state']; }?>" required>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 field">
                                                        <label>City <span>*</span> </label>
                                                        <input type="text" name="city" id="city" placeholder="City" value="<?php if(isset($_GET['edit'])){ echo $data['city']; }?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 field">
                                                        <label>Pincode <span>*</span> </label>
                                                        <input type="text" name="pincode" id="pincode" placeholder="Pincode" value="<?php if(isset($_GET['edit'])){ echo $data['pincode']; }?>">
                                                    </div>
                                                    <div class="col-md-12 col-sm-12 field">
                                                        <label>Address </label>
                                                        <input type="text" name="address" id="address" placeholder="Address" value="<?php if(isset($_GET['edit'])){ echo $data['address']; }?>">
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 field">
